...
function pkgscheck_flux() {
	...
	echo -e "\033[34m[\033[31m+\033[34m] Checking for dhcpd\033[0m"
	if ! hash dhcpd 2>/dev/null;then
		echo -e "\033[31mNot Found\033[0m"
		echo -e "Installing \033[31mdhcpd\033[0m"
...
if [ $username != "root" ];then
	echo -e "\033[31mPlease run this script as the user root try doing sudo bash install.sh"
	exit
fi
...
if [ $found != 1 ];then
	echo -e "\033[31mNot Found \033[0m";echo "Adding $source to $path";echo $source >> $path;
fi
...
echo -e "\033[34m[\033[31m+\033[34m] Checking for git"
sleep 5
if [ -x $git ];then
	echo -e "\033[32mFound\033[0m"
else
	echo -e "\033[31mNot Found\033[0m"
	echo -e "Installing \033[31mgit\033[0m"
	apt-get install git -y
fi
echo -e "\033[34m[\033[31m+\033[34m] Checking for python2"
sleep 5
if [ -f $python ];then
	echo -e "\033[32mFound\033[0m"
else
	echo -e "\033[31mNot Found\033[0m"
	echo -e "Installing \033[31mpython2\033[0m"
	apt-get install python2 -y
fi
echo -e "\033[34m[\033[31m+\033[34m] Checking for python2-pip"
sleep 5
if [ "$pip" != "$piperror" ];then
	echo -e "\033[32mFound\033[0m"
else
	echo -e "\033[31mNot Found\033[0m"
	echo -e "Installing \033[31mpython2-pip\033[0m"
	#curl https://bootstrap.pypa.io/pip/2.7/get-pip.py --output get-pip.py
	python2 incase/get-pip.py
fi
echo -e "\033[34m[\033[31m+\033[34m] Checking for nmap"
sleep 5
if [ -f $nmap ];then
	echo -e "\033[32mFound\033[0m"
else
	echo -e "\033[31mNot Found\033[0m"
	echo -e "Installing \033[31mnmap\033[0m"
...
if [ -f $phpcgi ];then
	...
	echo -e "\033[31mNot Found\033[0m"
	echo -e "Installing \033[31mphp-cgi\033[0m"
...
echo -e "Removing \033[31mpyrit\033[0m"
